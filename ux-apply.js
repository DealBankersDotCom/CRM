(function(){
  // Apply UX preferences globally. Include this file on any page after Firebase auth scripts.
  let cachedUx=null;
  ...
  function ensureDriveBar(ux){
    ...
    // Default actions (can be page-aware later)
    bar.innerHTML = `
    ...
    bar.querySelectorAll('button')[2].onclick = ()=> window.open('tel:+12108165112'); // temp
